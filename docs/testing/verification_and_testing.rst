...
#. Depending on the test you executed, you should see results similar to the following examples:
   ...
   .. tabs::
      ...
      .. tab:: NFC_RDR_STANDARD_NO_CERT
            ...
            When access is granted, the device also signals this event by turning on a dedicated LED. 
            For details, see the :ref:`access decision indicator <access_decision_indicator>` section.
