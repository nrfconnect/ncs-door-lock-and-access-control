...
To test the device, familiarize yourself with the user interface of the |APP_NAME| when Matter is enabled.
...
* nRF Door Lock App build with Matter support - A development kit from Nordic Semiconductor equipped with Aliro door lock firmware :ref:`that supports Matter <building_and_running>`.
...
1. Prepare the door lock device:
   ...
   .. tabs::
      ...
      .. tab:: NFC
         ...
         a. Flash the Aliro door lock firmware to your Nordic development kit (see :ref:`building_and_running`).
      ...
      .. tab:: NFC + Bluetooth LE + UWB
         ...
         a. Flash the Aliro door lock firmware with UWB support enabled to your Nordic development kit (see :ref:`building_and_running` with the ``-Dmatter-aliro-door-lock-app_SNIPPET='uwb_qm35'`` option).
