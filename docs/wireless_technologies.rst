.. _wireless_technologies:

Wireless technologies
#####################

The |APPS_NAME| combine multiple wireless technologies to deliver a complete door lock and access control reference.
Pages in this section describe each technology used across the |REPO_NAME| and how it integrates with the rest of the application.
...
.. toctree::
   ...
   wireless_technologies/aliro/door_lock_app_aliro.rst
   wireless_technologies/nfc/door_lock_app_nfc.rst
   wireless_technologies/matter/door_lock_app_matter.rst
   wireless_technologies/bluetooth_le/door_lock_app_ble.rst
   wireless_technologies/uwb/door_lock_app_uwb.rst
