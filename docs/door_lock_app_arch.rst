...
.. list-table::
   ...
   * - Kconfig option
     - Description
   * - ``CONFIG_DOOR_LOCK_ACCESS_MANAGER_IMPLEMENTATION_DEFAULT``
     - The default implementation (:file:`access_manager_impl_default`), designed to cover typical access control scenarios.
       ...
       You can adjust this implementation through Kconfig options.
       ...
       For available Kconfig options, see the :ref:`addon_architecture_kconfig_default` subsection.
   * - ``CONFIG_DOOR_LOCK_ACCESS_MANAGER_IMPLEMENTATION_CUSTOM``
     - Allows you to provide custom logic (:file:`access_manager_impl_custom`) by implementing the interface defined in the
       :file:`access_manager.h` file.
...
.. list-table::
   ...
   * - ``CONFIG_DOOR_LOCK_ACCESS_MANAGER_ACCESS_CREDENTIAL_MAX_STORED_KEYS``
     - Defines the maximum number of Access Credential public keys that can be stored when using the default Access Manager implementation
       (``CONFIG_DOOR_LOCK_ACCESS_MANAGER_IMPLEMENTATION_DEFAULT``).
...
.. list-table::
   ...
   * - Kconfig option
     - Description
   * - ``CONFIG_DOOR_LOCK_ACCESS_MANAGER_ACCESS_CREDENTIAL_MAX_STORED_KEYS``
     - Sets the maximum number of Access Credential public keys that can be stored when using the default Access Manager implementation
       (``CONFIG_DOOR_LOCK_ACCESS_MANAGER_IMPLEMENTATION_DEFAULT``).
   ...
   * - ``CONFIG_DOOR_LOCK_ACCESS_MANAGER_CREDENTIAL_ISSUER_MAX_STORED_KEYS``
     - Configures the maximum number of Credential Issuer public keys that can be stored.
       ...
       See :file:`app/src/aliro/access_manager_impl_default/Kconfig` for details.
