...
{
	snprintf(keyName.data(), keyName.size(), "%s/%u", StorageKeys::kStorageKeyNameAccessCredentialPublicKey, keyId);
}
...
{
	const size_t acSlots{ CONFIG_ALIRO_ACCESS_MANAGER_MAX_STORED_KEYS };
