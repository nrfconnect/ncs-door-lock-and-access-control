...
public:
	 ...
	 *
	 * When true, device info and capabilities have been retrieved and cached.
	 */
	...
	/**
	 * @brief Gets the CCC capabilities.
	 *
	 * @return Pointer to the CCC capabilities structure, or nullptr if not available.
	 */
	const CccCaps *GetCccCapabilities() const { return mCccCapsValid ? &mCccCaps : nullptr; }
