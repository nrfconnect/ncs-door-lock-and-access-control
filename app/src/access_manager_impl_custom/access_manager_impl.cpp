...
AliroError AccessManagerImpl::_Init(const Callbacks &)
{
	LOG_INF("AccessManagerImpl custom init");
	return ALIRO_ERROR_NOT_IMPLEMENTED;
}

AliroError AccessManagerImpl::_StartAccessDecision(const CryptoTypes::PublicKey &, SessionContext)
{
...
AliroError AccessManagerImpl::_StartAccessDecision(const CryptoTypes::PublicKey &, uint32_t, const CryptoTypes::Ursk &,
						   SessionContext)
{
