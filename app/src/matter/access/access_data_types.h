...
constexpr size_t kMaxCredentialLength{ CONFIG_LOCK_MAX_CREDENTIAL_LENGTH };
...
public:
	...
	{
		VerifyOrReturnError(IN_RANGE(credentialIndex, 1, CONFIG_LOCK_MAX_NUM_CREDENTIALS_PER_TYPE),
