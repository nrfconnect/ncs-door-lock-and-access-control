...
public:
	 ...
	 */
	using AccessDocumentRequestParams = Interface::Access::AccessDocumentRequestParams;
	 ...
	 */
	AliroError
	VerifyAccessCredential(const CryptoTypes::PublicKey &userPublicKey, SessionContext sessionContext,
	 ...
	 * @return ALIRO_NO_ERROR on success, error code otherwise.
	 */
	AliroError VerifyKPersistentKey(CryptoTypes::KeyId kpersistentKeyId, SessionContext sessionContext);
