...
#if defined(CONFIG_DOOR_LOCK_BLE_UWB) && defined(CONFIG_DOOR_LOCK_ALIRO_UWB_QM35_DISAMBIGUATION)
	Aliro::Uwb::UltraWideBandInstance().StopRadarSession();
#endif // CONFIG_DOOR_LOCK_BLE_UWB && CONFIG_DOOR_LOCK_ALIRO_UWB_QM35_DISAMBIGUATION
}
