...
#define GENERATED_ATTRIBUTES                                                                                                                         \
	{                                                                                                                                            \
		...
		{ ZAP_EMPTY_DEFAULT(), 0x00000002, 1, ZAP_TYPE(BOOLEAN), ZAP_ATTRIBUTE_MASK(READABLE) }, /* ActuatorEnabled                          \
													  */                                         \
		{ ZAP_SIMPLE_DEFAULT(10), 0x00000011, 2, ZAP_TYPE(INT16U), ZAP_ATTRIBUTE_MASK(READABLE) }, /* NumberOfTotalUsersSupported            \
													    */                                       \
		...
		{ ZAP_MIN_MAX_DEFAULTS_INDEX(2), 0x00000031, 1, ZAP_TYPE(INT8U),                                                                     \
		  ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(READABLE) }, /* UserCodeTemporaryDisableTime       \
														*/                                   \
		...
		{ ZAP_EMPTY_DEFAULT(), 0x00000083, 0, ZAP_TYPE(ARRAY),                                                                               \
		  ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(READABLE) }, /* AliroExpeditedTransactionSupportedProtocolVersions       \
											  */                                                         \
		...
		{ ZAP_EMPTY_DEFAULT(), 0x00000088, 2, ZAP_TYPE(INT16U),                                                                              \
		  ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(READABLE) }, /* NumberOfAliroEndpointKeysSupported                       \
											  */                                                         \
		{ ZAP_SIMPLE_DEFAULT(11665), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32), ZAP_ATTRIBUTE_MASK(READABLE) }, /* FeatureMap                        \
														 */                                  \
...
#define GENERATED_ENDPOINT_TYPES                                                                                       \
	{                                                                                                              \
		{ ZAP_CLUSTER_INDEX(0), 17, 13 },                                                                      \
		{ ZAP_CLUSTER_INDEX(17), 3, 37 },                                                                      \
	}
