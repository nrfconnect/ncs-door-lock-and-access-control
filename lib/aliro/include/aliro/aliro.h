...
public:
	 ...
	 */
	AliroError Init(const AliroConfig &config);
	 ...
	 */
	AliroError Provision(CryptoTypes::KeyId privateKeyId, const CryptoTypes::PublicKey &publicKey,
			     CryptoTypes::KeyId groupResolvingKeyId, const Identifier &identifier);
