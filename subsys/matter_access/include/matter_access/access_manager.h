...
template <Data::CredentialsBits CRED_BIT_MASK> class AccessManager {
...
public:
	...
	/**
	 * @brief Signature of the callback fired when the credential is set or loaded from storage.
	 *
	 * The execution of the callback code might need to be scheduled to another thread
	 * to avoid blocking of the Matter messaging.
	 */
	using SetOrLoadCredentialCallback = void (*)(uint16_t credentialIndex, CredentialTypeEnum credentialType,
...
#endif // CONFIG_DOOR_LOCK_MATTER_ACCESS_SCHEDULES
#endif // CONFIG_DOOR_LOCK_MATTER_ACCESS_DEBUG
...
private:
	struct CredentialsIndexes {
		using CredentialList = Data::IndexList<CONFIG_DOOR_LOCK_MATTER_ACCESS_MAX_NUM_CREDENTIALS_PER_TYPE>;
		CredentialList mCredentialsIndexes[chip::to_underlying(CredentialTypeEnum::kUnknownEnumValue) - 1];

		CredentialList &Get(CredentialTypeEnum type)
		{
			return mCredentialsIndexes[chip::to_underlying(type) - 1];
		}
	};

	using UsersIndexes = Data::IndexList<CONFIG_DOOR_LOCK_MATTER_ACCESS_MAX_NUM_USERS>;

#ifdef CONFIG_DOOR_LOCK_MATTER_ACCESS_SCHEDULES
	struct WeekDayScheduleIndexes {
		using ScheduleList =
			Data::IndexList<CONFIG_DOOR_LOCK_MATTER_ACCESS_SCHEDULES_MAX_WEEKDAY_SCHEDULES_PER_USER>;
		ScheduleList mScheduleIndexes[CONFIG_DOOR_LOCK_MATTER_ACCESS_MAX_NUM_USERS];
	...
	struct YearDayScheduleIndexes {
		using ScheduleList =
			Data::IndexList<CONFIG_DOOR_LOCK_MATTER_ACCESS_SCHEDULES_MAX_YEARDAY_SCHEDULES_PER_USER>;
		ScheduleList mScheduleIndexes[CONFIG_DOOR_LOCK_MATTER_ACCESS_MAX_NUM_USERS];

		ScheduleList &Get(uint16_t userIndex) { return mScheduleIndexes[userIndex - 1]; }
	};

	using HolidayScheduleIndexes = Data::IndexList<CONFIG_DOOR_LOCK_MATTER_ACCESS_SCHEDULES_MAX_HOLIDAY_SCHEDULES>;
#endif // CONFIG_DOOR_LOCK_MATTER_ACCESS_SCHEDULES
	...
	static bool DoSetCredential(Data::Credential &credential, uint16_t credentialIndex, chip::FabricIndex creator,
				    ...
				    CredentialTypeEnum credentialType, const chip::ByteSpan &secret);

	SetOrLoadCredentialCallback mSetCredentialCallback{ nullptr };
	ClearCredentialCallback mClearCredentialCallback{ nullptr };
	ValidateCredentialCallback mValidateCredentialCallback{ nullptr };
	SetOrLoadCredentialCallback mLoadCredentialCallback{ nullptr };

	Data::Credentials<CRED_BIT_MASK> mCredentials{};
	CredentialsIndexes mCredentialsIndexes{};

	Data::User mUsers[CONFIG_DOOR_LOCK_MATTER_ACCESS_MAX_NUM_USERS] = {};
	UsersIndexes mUsersIndexes{};

#ifdef CONFIG_DOOR_LOCK_MATTER_ACCESS_SCHEDULES
	Data::WeekDaySchedule
		mWeekDaySchedule[CONFIG_DOOR_LOCK_MATTER_ACCESS_MAX_NUM_USERS]
				[CONFIG_DOOR_LOCK_MATTER_ACCESS_SCHEDULES_MAX_WEEKDAY_SCHEDULES_PER_USER] = {};
	WeekDayScheduleIndexes mWeekDayScheduleIndexes = {};

	Data::YearDaySchedule
		mYearDaySchedule[CONFIG_DOOR_LOCK_MATTER_ACCESS_MAX_NUM_USERS]
				[CONFIG_DOOR_LOCK_MATTER_ACCESS_SCHEDULES_MAX_YEARDAY_SCHEDULES_PER_USER] = {};
	YearDayScheduleIndexes mYearDayScheduleIndexes = {};

	Data::HolidaySchedule mHolidaySchedule[CONFIG_DOOR_LOCK_MATTER_ACCESS_SCHEDULES_MAX_HOLIDAY_SCHEDULES];
...
static constexpr Data::CredentialsBits kAccessManagerSupportedCredentialTypesBitMask{
#ifdef CONFIG_DOOR_LOCK_MATTER_ACCESS_CREDENTIAL_TYPES_PIN
	Data::PIN |
#endif // CONFIG_DOOR_LOCK_MATTER_ACCESS_CREDENTIAL_TYPES_PIN
#ifdef CONFIG_DOOR_LOCK_MATTER_ACCESS_CREDENTIAL_TYPES_RFID
	Data::RFID |
#endif // CONFIG_DOOR_LOCK_MATTER_ACCESS_CREDENTIAL_TYPES_RFID
#ifdef CONFIG_DOOR_LOCK_MATTER_ACCESS_CREDENTIAL_TYPES_FINGER
	Data::FINGER |
#endif // CONFIG_DOOR_LOCK_MATTER_ACCESS_CREDENTIAL_TYPES_FINGER
#ifdef CONFIG_DOOR_LOCK_MATTER_ACCESS_CREDENTIAL_TYPES_VEIN
	Data::VEIN |
#endif // CONFIG_DOOR_LOCK_MATTER_ACCESS_CREDENTIAL_TYPES_VEIN
#ifdef CONFIG_DOOR_LOCK_MATTER_ACCESS_CREDENTIAL_TYPES_FACE
	Data::FACE |
#endif // CONFIG_DOOR_LOCK_MATTER_ACCESS_CREDENTIAL_TYPES_FACE
#ifdef CONFIG_DOOR_LOCK_MATTER_ACCESS_CREDENTIAL_TYPES_ALIRO
	Data::ALIRO_CRED_ISSUER | Data::ALIRO_EV_EP | Data::ALIRO_NON_EV_EP |
#endif // CONFIG_DOOR_LOCK_MATTER_ACCESS_CREDENTIAL_TYPES_ALIRO
	0
};

using AccessManagerType = AccessManager<kAccessManagerSupportedCredentialTypesBitMask>;
