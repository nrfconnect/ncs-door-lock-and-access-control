 ...
 * - credential index: from 1 to CONFIG_DOOR_LOCK_MATTER_ACCESS_MAX_NUM_CREDENTIALS_PER_TYPE.
 * On the other hand, a user is referenced by its user index: from 1 to CONFIG_DOOR_LOCK_MATTER_ACCESS_MAX_NUM_USERS.
 *
