 ...
 * fresh nonce. Metadata (entry ID, data length, nonce, and optionally the
 * rollback counter) is stored alongside the ciphertext. On failure the
 * partially written entry is deleted.
 *
