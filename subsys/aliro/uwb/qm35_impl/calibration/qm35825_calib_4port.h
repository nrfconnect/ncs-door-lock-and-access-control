...
/* Antenna set 0: TWR on ant 2 and 4. */
static const uint8_t qm35825_calib_4port_ant_pair_0_ant_path[] = { 0x01, 0x03 };
static const uint8_t qm35825_calib_4port_ant_set0_tx_ant_paths[] = { 0x00, 0xFF };
static const uint8_t qm35825_calib_4port_ant_set0_rx_ants[] = { 0x00, 0xFF, 0xFF };

/* Antenna set 2: Radar on ant 2 and 4. */
static const uint8_t qm35825_calib_4port_ant_set2_tx_ant_paths[] = { 0x02, 0xFF };
static const uint8_t qm35825_calib_4port_ant_set2_rx_ants[] = { 0x03, 0xFF, 0xFF };

/* Antenna set 1: TWR on ant 2 and 3. */
static const uint8_t qm35825_calib_4port_ant_pair_1_ant_path[] = { 0x01, 0x04 };
static const uint8_t qm35825_calib_4port_ant_set1_tx_ant_paths[] = { 0x00, 0xFF };
static const uint8_t qm35825_calib_4port_ant_set1_rx_ants[] = { 0x01, 0xFF, 0xFF };

/* Antenna set 3: Radar on ant 2 and 3. */
static const uint8_t qm35825_calib_4port_ant_set3_tx_ant_paths[] = { 0x02, 0xFF };
static const uint8_t qm35825_calib_4port_ant_set3_rx_ants[] = { 0x04, 0xFF, 0xFF };

static const uint16_t qm35825_calib_4port_pdoa_lut0_ch5[][2] = {
...
static const uint16_t qm35825_calib_4port_pdoa_lut1_ch9[][2] = {
...
static const uint16_t qm35825_calib_4port_pdoa_lut2_ch5[][2] = {
...
static const uint16_t qm35825_calib_4port_pdoa_lut3_ch9[][2] = {
...
static const struct cherry_calib_key qm35825_calib_4port_keys[] = {
	/* Global Calibration. */
	CHERRY_CALIB_UINT8("xtal_trim", 0x28),

	/* PDOA LUT Configuration. */
	CHERRY_CALIB_NUMBER_ARRAY_2D("pdoa_lut0.data", qm35825_calib_4port_pdoa_lut0_ch5),
	CHERRY_CALIB_NUMBER_ARRAY_2D("pdoa_lut1.data", qm35825_calib_4port_pdoa_lut1_ch9),
	CHERRY_CALIB_NUMBER_ARRAY_2D("pdoa_lut2.data", qm35825_calib_4port_pdoa_lut2_ch5),
	CHERRY_CALIB_NUMBER_ARRAY_2D("pdoa_lut3.data", qm35825_calib_4port_pdoa_lut3_ch9),

	/* ANT0 = TX_ANT1. */
	CHERRY_CALIB_UINT32("ant0.ch5.ref_frame0.tx_power_index", 0X4E4E4E4E),
	CHERRY_CALIB_UINT32("ant0.ch9.ref_frame0.tx_power_index", 0X45454545),
	CHERRY_CALIB_UINT32("ant0.ch5.ref_frame0.max_gating_gain", 0x80808080),
	CHERRY_CALIB_UINT32("ant0.ch9.ref_frame0.max_gating_gain", 0x80808080),

	CHERRY_CALIB_UINT32("ant0.ch5.ant_delay", 16410),
	CHERRY_CALIB_UINT8("ant0.ch5.pg_delay", 0x34),
	CHERRY_CALIB_UINT32("ant0.ch9.ant_delay", 16400),
	CHERRY_CALIB_UINT8("ant0.ch9.pg_delay", 0x34),
	...
	CHERRY_CALIB_UINT8("ant1.ch5.pg_delay", 0x34),
	CHERRY_CALIB_UINT32("ant1.ch9.ant_delay", 16400),
	CHERRY_CALIB_UINT8("ant1.ch9.pg_delay", 0x34),
	...
	CHERRY_CALIB_UINT8("ant2.ch5.pg_delay", 0x34),
	CHERRY_CALIB_UINT32("ant2.ch9.ant_delay", 16400),
	CHERRY_CALIB_UINT8("ant2.ch9.pg_delay", 0x34),

	CHERRY_CALIB_UINT8("ant2.transceiver", 0),
	CHERRY_CALIB_UINT8("ant2.port", 2),
	CHERRY_CALIB_UINT8("ant2.ext_sw_cfg", 0x00),
	CHERRY_CALIB_UINT8("ant2.lna", 0),

	CHERRY_CALIB_UINT32("ant3.ch5.ant_delay", 16410),
	CHERRY_CALIB_UINT8("ant3.ch5.pg_delay", 0x34),
	CHERRY_CALIB_UINT32("ant3.ch9.ant_delay", 16400),
	CHERRY_CALIB_UINT8("ant3.ch9.pg_delay", 0x34),
	...
	CHERRY_CALIB_UINT32("ant4.ch5.ant_delay", 16410),
	CHERRY_CALIB_UINT8("ant4.ch5.pg_delay", 0x34),
	CHERRY_CALIB_UINT32("ant4.ch9.ant_delay", 16400),
	CHERRY_CALIB_UINT8("ant4.ch9.pg_delay", 0x34),

	CHERRY_CALIB_UINT8("ant4.transceiver", 1),
	CHERRY_CALIB_UINT8("ant4.port", 3),
	CHERRY_CALIB_UINT8("ant4.ext_sw_cfg", 0x00),
	CHERRY_CALIB_UINT8("ant4.lna", 1),

	/* Ant Pair 0 to measure Azimuth between ant port 2 and ant port 4. */
	CHERRY_CALIB_UINT8("ant_pair0.axis", 0),
	CHERRY_CALIB_NUMBER_ARRAY_1D("ant_pair0.ant_paths", qm35825_calib_4port_ant_pair_0_ant_path),
	...
	/* Antenna set 0: TWR on ant 2 and 4. */
	CHERRY_CALIB_NUMBER_ARRAY_1D("ant_set0.tx_ant_paths", qm35825_calib_4port_ant_set0_tx_ant_paths),
	CHERRY_CALIB_UINT8("ant_set0.nb_rx_ants", 1),
	CHERRY_CALIB_BOOL("ant_set0.rx_ants_are_pairs", true),
	CHERRY_CALIB_NUMBER_ARRAY_1D("ant_set0.rx_ants", qm35825_calib_4port_ant_set0_rx_ants),
	CHERRY_CALIB_UINT8("ant_set0.tx_power_control", 0x03),

	/* Antenna set 2: Radar on ant 2 and 4. */
	CHERRY_CALIB_NUMBER_ARRAY_1D("ant_set2.tx_ant_paths", qm35825_calib_4port_ant_set2_tx_ant_paths),
	CHERRY_CALIB_UINT8("ant_set2.nb_rx_ants", 1),
	CHERRY_CALIB_BOOL("ant_set2.rx_ants_are_pairs", false),
	CHERRY_CALIB_NUMBER_ARRAY_1D("ant_set2.rx_ants", qm35825_calib_4port_ant_set2_rx_ants),
	CHERRY_CALIB_UINT8("ant_set2.tx_power_control", 0x80),

	/* Ant Pair 1 to measure Azimuth between ant port 3 and ant port 4. */
	CHERRY_CALIB_UINT8("ant_pair1.axis", 0),
	CHERRY_CALIB_NUMBER_ARRAY_1D("ant_pair1.ant_paths", qm35825_calib_4port_ant_pair_1_ant_path),
	...
	/* Antenna set 1 TWR on ant 2 and 3. */
	CHERRY_CALIB_NUMBER_ARRAY_1D("ant_set1.tx_ant_paths", qm35825_calib_4port_ant_set1_tx_ant_paths),
	CHERRY_CALIB_UINT8("ant_set1.nb_rx_ants", 1),
	CHERRY_CALIB_BOOL("ant_set1.rx_ants_are_pairs", true),
	CHERRY_CALIB_NUMBER_ARRAY_1D("ant_set1.rx_ants", qm35825_calib_4port_ant_set1_rx_ants),
	CHERRY_CALIB_UINT8("ant_set1.tx_power_control", 0x03),

	/* Antenna set 3: Radar on ant 2 and 3. */
	CHERRY_CALIB_NUMBER_ARRAY_1D("ant_set3.tx_ant_paths", qm35825_calib_4port_ant_set3_tx_ant_paths),
	CHERRY_CALIB_UINT8("ant_set3.nb_rx_ants", 1),
	CHERRY_CALIB_BOOL("ant_set3.rx_ants_are_pairs", false),
	CHERRY_CALIB_NUMBER_ARRAY_1D("ant_set3.rx_ants", qm35825_calib_4port_ant_set3_rx_ants),
	CHERRY_CALIB_UINT8("ant_set3.tx_power_control", 0x80),

	CHERRY_CALIB_UINT32("debug.tx_power", 0x60606060),
	CHERRY_CALIB_BOOL("debug.pa_enabled", false),
	CHERRY_CALIB_UINT8("debug.rx_segment", 0x00),
};

static const struct cherry_calib qm35825_calib_4port = {
	.n_keys = sizeof(qm35825_calib_4port_keys) / sizeof(qm35825_calib_4port_keys[0]),
	.keys = qm35825_calib_4port_keys,
};
