...
static const uint8_t qm35825_calib_2port_ant_pair_0_ant_path[] = { 0x01, 0x03 };
static const uint8_t qm35825_calib_2port_ant_set0_tx_ant_paths[] = { 0x00, 0xFF };
static const uint8_t qm35825_calib_2port_ant_set0_rx_ants[] = { 0x00, 0xFF, 0xFF };

/* Antenna set 2: Radar on ant 2 and 4. */
static const uint8_t qm35825_calib_2port_ant_set2_tx_ant_paths[] = { 0x02, 0xFF };
static const uint8_t qm35825_calib_2port_ant_set2_rx_ants[] = { 0x03, 0xFF, 0xFF };

/* Antenna set 1: TWR on ant 2 and 3. */
static const uint8_t qm35825_calib_2port_ant_pair_1_ant_path[] = { 0x01, 0x04 };
static const uint8_t qm35825_calib_2port_ant_set1_tx_ant_paths[] = { 0x00, 0xFF };
static const uint8_t qm35825_calib_2port_ant_set1_rx_ants[] = { 0x01, 0xFF, 0xFF };

/* Antenna set 3: Radar on ant 2 and 3. */
static const uint8_t qm35825_calib_2port_ant_set3_tx_ant_paths[] = { 0x02, 0xFF };
static const uint8_t qm35825_calib_2port_ant_set3_rx_ants[] = { 0x04, 0xFF, 0xFF };
...
static const struct cherry_calib_key qm35825_calib_2port_keys[] = {
	...
	CHERRY_CALIB_NUMBER_ARRAY_2D("pdoa_lut0.data", qm35825_calib_2port_pdoa_lut0_ch5),
	CHERRY_CALIB_NUMBER_ARRAY_2D("pdoa_lut1.data", qm35825_calib_2port_pdoa_lut1_ch9),
	CHERRY_CALIB_NUMBER_ARRAY_2D("pdoa_lut2.data", qm35825_calib_2port_pdoa_lut2_ch5),
	CHERRY_CALIB_NUMBER_ARRAY_2D("pdoa_lut3.data", qm35825_calib_2port_pdoa_lut3_ch9),
	...
	CHERRY_CALIB_NUMBER_ARRAY_1D("ant_pair0.ant_paths", qm35825_calib_2port_ant_pair_0_ant_path),
	...
	/* Antenna set 0: TWR on ant 2 and 4. */
	CHERRY_CALIB_NUMBER_ARRAY_1D("ant_set0.tx_ant_paths", qm35825_calib_2port_ant_set0_tx_ant_paths),
	CHERRY_CALIB_UINT8("ant_set0.nb_rx_ants", 1),
	CHERRY_CALIB_BOOL("ant_set0.rx_ants_are_pairs", true),
	CHERRY_CALIB_NUMBER_ARRAY_1D("ant_set0.rx_ants", qm35825_calib_2port_ant_set0_rx_ants),
	CHERRY_CALIB_UINT8("ant_set0.tx_power_control", 0x03),

	/* Antenna set 2: Radar on ant 2 and 4. */
	CHERRY_CALIB_NUMBER_ARRAY_1D("ant_set2.tx_ant_paths", qm35825_calib_2port_ant_set2_tx_ant_paths),
	CHERRY_CALIB_UINT8("ant_set2.nb_rx_ants", 1),
	CHERRY_CALIB_BOOL("ant_set2.rx_ants_are_pairs", false),
	CHERRY_CALIB_NUMBER_ARRAY_1D("ant_set2.rx_ants", qm35825_calib_2port_ant_set2_rx_ants),
	...
	CHERRY_CALIB_NUMBER_ARRAY_1D("ant_pair1.ant_paths", qm35825_calib_2port_ant_pair_1_ant_path),
	...
	/* Antenna set 1 TWR on ant 2 and 3. */
	CHERRY_CALIB_NUMBER_ARRAY_1D("ant_set1.tx_ant_paths", qm35825_calib_2port_ant_set1_tx_ant_paths),
	CHERRY_CALIB_UINT8("ant_set1.nb_rx_ants", 1),
	CHERRY_CALIB_BOOL("ant_set1.rx_ants_are_pairs", true),
	CHERRY_CALIB_NUMBER_ARRAY_1D("ant_set1.rx_ants", qm35825_calib_2port_ant_set1_rx_ants),
	CHERRY_CALIB_UINT8("ant_set1.tx_power_control", 0x03),

	/* Antenna set 3: Radar on ant 2 and 3. */
	CHERRY_CALIB_NUMBER_ARRAY_1D("ant_set3.tx_ant_paths", qm35825_calib_2port_ant_set3_tx_ant_paths),
	CHERRY_CALIB_UINT8("ant_set3.nb_rx_ants", 1),
	CHERRY_CALIB_BOOL("ant_set3.rx_ants_are_pairs", false),
	CHERRY_CALIB_NUMBER_ARRAY_1D("ant_set3.rx_ants", qm35825_calib_2port_ant_set3_rx_ants),
...
static const struct cherry_calib qm35825_calib_2port = {
	.n_keys = sizeof(qm35825_calib_2port_keys) / sizeof(qm35825_calib_2port_keys[0]),
