...
#define rfalST25R200ObsModeTx()                 st25r200WriteMultipleTestRegister(0x02U, (uint8_t[]) {(uint8_t)(gRFAL.conf.obsvModeTx>>8U), (uint8_t)(gRFAL.conf.obsvModeTx&0xFFU)}, 2U)  /*!< Enable Tx Observation mode                                           */
#define rfalST25R200ObsModeRx()                 st25r200WriteMultipleTestRegister(0x02U, (uint8_t[]) {(uint8_t)(gRFAL.conf.obsvModeRx>>8U), (uint8_t)(gRFAL.conf.obsvModeRx&0xFFU)}, 2U)  /*!< Enable Rx Observation mode                                           */
